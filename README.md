...
* Import the sample dataset and process it as needed (also hosted here: http://pathgather-storage.s3.amazonaws.com/data-challenge/Pathgather_Team_Learning_Events_Aug_26_2017.csv.tar.gz)
* Build a basic recommendation algorithm that:
